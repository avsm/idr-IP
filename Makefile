...
recvtest: bittwiddle.o bittwiddle.idr recvtest.idr packetformat.idr IPDSL.idr
	idris recvtest.idr -o recvtest

sendtest: bittwiddle.o bittwiddle.idr sendtest.idr packetformat.idr IPDSL.idr
